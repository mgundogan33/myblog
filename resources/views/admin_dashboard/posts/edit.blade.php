                                    ...
                                    <div class="border border-3 p-4 rounded">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value='{{ old('title', $post->title) }}' name='title'
                                                required class="form-control" id="inputProductTitle">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value='{{ old('slug', $post->slug) }}'
                                                class="form-control" required name='slug' id="inputProductTitle">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea required class="form-control" name='excerpt' id="inputProductDescription"
