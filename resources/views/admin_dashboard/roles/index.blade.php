            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto"><a href="{{ route('admin.roles.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex order-actions">
                                                ...
                                                <a href="#"
                                                    onclick="event.preventDefault(); document.getElementById('delete_form_{{ $role->id }}').submit();"
                                                    class="ms-3"><i class='bx bxs-trash'></i></a>
                                                <form method='post' action="{{ route('admin.roles.destroy', $role) }}"
                                                    id='delete_form_{{ $role->id }}'>@csrf @method('DELETE')</form>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
