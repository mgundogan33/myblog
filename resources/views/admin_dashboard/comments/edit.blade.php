        ...
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body p-4">
                                ...
                                <div class="col-lg-12">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name='the_comment' id='post_comment' class="form-control" id="inputProductDescription"
                                                rows="3">{{ old('the_comment', $comment->the_comment) }}</textarea>
                    ...
                    <form id="comment_delete_form_{{ $comment->id }}" method="post"
                        action="{{ route('admin.comments.destroy', $comment) }}">@csrf @method('DELETE')
                    </form>
                </div>
            </div>
