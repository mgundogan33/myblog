                ...
                <div class="col-md-8">
                        ...
                        <div class="col-md-12 animate-box">
                            <div class="classes class-single">
                                <div class="classes-img"
                                    style="background-image: url({{ asset($post->image ? 'storage/' . $post->image->path : 'storage/placeholders/thumbnail_placeholder.svg' . '') }});">
                                </div>
                    ...
                    <div class="row animate-box">
                        <div class="col-md-12">
                                ...
                                <form method="POST" action="{{ route('posts.add_comment', $post) }}">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="the_comment" id="the_comment" cols="30" rows="10" class="form-control"
                            ...
                            @guest
                                <p class="lead"><a href="{{ route('login') }}">Giriş </a> OR <a
                                        href="{{ route('register') }}">Kayıt Ol</a> Yorum yaz</p>
                            @endguest
                        </div>
                    </div>
                </div>
